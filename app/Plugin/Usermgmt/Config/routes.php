...
Router::connect('/dashboards',array('plugin'=>'usermgmt','controller'=>'dashboards','action'=>'index'));
...
Router::connect('/add-user',array('plugin'=>'usermgmt','controller'=>'users','action'=>'add'));
